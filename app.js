...
function showDedication(){var d=document.getElementById('dedicationOverlay');if(!d)return;d.style.display='flex';d.querySelector('.dedication-btn').onclick=function(){d.style.display='none'};}
